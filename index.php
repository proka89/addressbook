      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td><div class="btn-group"><a href="edit_contact.php?id=<?php echo $row["id"]; ?>" class="btn btn-primary" role="button" >Edit</a><a href="#" class="btn btn-danger delete" role="button" id='<?php echo $id; ?>'>Delete</a></div></td>
          </tr>
        </tbody>
        <?php
              }
